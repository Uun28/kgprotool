  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      ...
      >
        ...
        {status && (
          <div className={`text-center ${status.includes('sukses') || status.includes('berhasil') ? 'text-green-700 border-green-200 bg-green-50' : 'text-red-700 border-red-200 bg-white/90'} border rounded py-2 px-4 text-sm font-normal shadow-sm mt-1 transition-all duration-300 animate-fade-in`}>
            {status}
          </div>
        )}
          ...
          {loading ? (
            ...
            <>
              <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path d="M16 8l-6 6M8 8h8v8" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
