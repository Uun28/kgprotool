...
const menu = [
  { name: "Activation", icon: Users, path: "/resellers/activation" },
  { name: "Selling", icon: FileText, path: "/resellers/selling" },
    { name: "Options", icon: Settings, path: "/resellers/options" },
];

const API_LOGOUT = 'https://minangkabau-gsm.store/resellers.php?mode=logout';
